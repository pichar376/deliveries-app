...
import Input from "../../../../components/Search/components/Input/Input";
          ...
          return (
            <>
              <Stack sx={stackStyles}>
                <TextFieldBase labelProp="Order Id" />
                <AutocompleteBase
                  startAdornment={
                  ...
                  options={top100Films}
                  labelProp="Technician"
                />
              </Stack>
              <Stack sx={stackStyles}>
                <AutocompleteBase options={top100Films} labelProp="Platform" />
                <AutocompleteBase options={top100Films} labelProp="Drone" />
              </Stack>
            </>
          );
        }}
